                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="text-center">
                                        <img id="facePreview" class="img-circle img-bordered-sm"
                                            src="/storage/profile-photos/default-avatar.jpg" alt="User Image"
                            ...
                            <div class="card">
                                ...
                                <form id="updateProfileForm" enctype="multipart/form-data">
                                    <div class="card-body">
                                        ...
                                        <!-- Add this inside updateProfileForm -->
                                        <div class="form-group">
        ...
        document.getElementById('updateProfileForm').addEventListener('submit', async (e) => {
            ...
            try {
                const response = await fetch('/profile/update', {
                    ...
                    body: formData // Remove JSON.stringify and content-type
                });
